...
class AuthorizationTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->apiClient = new Authorization($httpClient);
        $this->mock = new Swift();
    }
    ...
    public function testShouldReturnErrorIfInvalidKey()
    {
        ...
        $result = json_decode($this->apiClient->oauth2($data));
    ...
    public function testShouldReturnErrorIfWrongAuthenticationPayload()
    {
        $data = $this->mock->oauth2Request();
        $this->mockHandler->append(new Response(
            200,
            [],
            json_encode(
    ...
    public function testShouldReturnAccessToken()
    {
        ...
        $this->assertEquals('86399', $result->data->refresh_token_expires_in);
    }
}
